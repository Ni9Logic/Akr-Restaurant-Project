...
const CarouselComponent = () => {
    return (
        <Carousel autoPlay={true} interval={3000} showIndicators={false} useKeyboardArrows={true} showThumbs={false} infiniteLoop={true} showArrows={false} showStatus={false}
            className='w-[300px] max-sm:w-[300px] max-sm:mt-[100px]'>
            <div>
