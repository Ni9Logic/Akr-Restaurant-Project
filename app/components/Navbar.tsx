...
export default function NavBar() {
    ...
    const MenuModal = ({ isOpen, onClose }: any) => (
        <div
            className={`fixed top-0 h-screen w-full opacity-100 bg-black/30 backdrop-blur-sm z-50 transition-all ease-in ${isOpen ? "transition-all ease-in transform translate-y-0" : "transform -translate-y-full"}`}
        >
            <div className="flex flex-col justify-center items-center h-full text-white space-y-4">
                {/* Add the menu items here */}
                <button className="hover:text-gray-300 border py-2 px-2 focus:border-gray-300 hover:cursor-pointer">Home</button>
                <a className="hover:text-gray-300 border py-2 px-2 focus:border-gray-300 hover:cursor-pointer">Menus</a>
                <a className="hover:text-gray-300 border py-2 px-2 focus:border-gray-300 hover:cursor-pointer">About Us</a>
                <a className="hover:text-gray-300 border py-2 px-2 focus:border-gray-300 hover:cursor-pointer">Contact Us</a>
                ...
                <button onClick={onClose} className="mt-10 hover:text-gray-300 border py-2 px-2 focus:border-gray-300 hover:cursor-pointer">
                    Close
                </button>
            </div>
        </div>
