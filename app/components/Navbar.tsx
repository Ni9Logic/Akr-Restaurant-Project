            ...
            <div className="items-center justify-between flex flex-row">
                <div className="mx-auto container flex flex-row justify-between text-center items-center">
                    <a href="http://localhost:3000/">
                        <Image src={logo} alt="logo" width={300} className="py-2 px-3 max-sm:w-150 max-[500px]:scale-45 max-sm:py-0 max-sm:px-0" />
                    </a>
                    ...
                    <div className="min-[1026px]:hidden transition-all ease-in-out cursor-pointer">
